...
class PermissionController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        try {
            ...
            $response = (new PermissionService())->getList($data);
    ...
    public function store(Request $request)
    {
        ...
        $response = (new PermissionService())->store($request->all());
    ...
    public function show(string $id)
    {
        ...
        $response = (new PermissionService())->findById($id);
    ...
    public function update(Request $request, string $id)
    {
        ...
        $response = (new PermissionService())->update($request->all(), $id);
    ...
    public function destroy(string $id)
    {
        ...
        $response = (new PermissionService())->delete($id);
